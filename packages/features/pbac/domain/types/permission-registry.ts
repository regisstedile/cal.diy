...
export interface PermissionDetails {
  ...
  scope?: Scope[];
  dependsOn?: PermissionString[];
  visibleWhen?: {
    teamPrivacy?: "private" | "public" | "both";
  };
}
...
export const getPermissionsForScope = (scope: Scope, isPrivate?: boolean): PermissionRegistry => {
  ...
  Object.entries(PERMISSION_REGISTRY).forEach(([resource, config]) => {
    ...
    const hasActions = Object.keys(filteredConfig).length > 1;
    if (hasActions) {
...
export const PERMISSION_REGISTRY: PermissionRegistry = {
  [Resource.All]: {
    _resource: { i18nKey: "pbac_resource_all" },
    [CrudAction.All]: {
  ...
  [Resource.Role]: {
    _resource: { i18nKey: "pbac_resource_role" },
    [CrudAction.Create]: {
  ...
  [Resource.EventType]: {
    _resource: { i18nKey: "pbac_resource_event_type" },
    [CrudAction.Create]: {
  ...
  [Resource.Team]: {
    _resource: { i18nKey: "pbac_resource_team" },
    [CrudAction.Create]: {
    ...
    [CustomAction.ListMembers]: {
      ...
      dependsOn: ["team.read"],
      visibleWhen: { teamPrivacy: "public" },
    },
    [CustomAction.ListMembersPrivate]: {
      ...
      descriptionI18nKey: "pbac_desc_list_team_members",
      dependsOn: ["team.read"],
      visibleWhen: { teamPrivacy: "private" },
    },
  ...
  [Resource.Organization]: {
    _resource: { i18nKey: "pbac_resource_organization" },
    [CrudAction.Create]: {
  ...
  [Resource.Booking]: {
    _resource: { i18nKey: "pbac_resource_booking" },
    [CrudAction.Read]: {
  ...
  [Resource.Insights]: {
    _resource: { i18nKey: "pbac_resource_insights" },
    [CrudAction.Read]: {
  ...
  [Resource.Workflow]: {
    _resource: { i18nKey: "pbac_resource_workflow" },
    [CrudAction.Create]: {
  ...
  [Resource.Attributes]: {
    _resource: { i18nKey: "pbac_resource_attributes" },
    [CrudAction.Read]: {
  ...
  [Resource.RoutingForm]: {
    _resource: { i18nKey: "pbac_resource_routing_form" },
    [CrudAction.Create]: {
  ...
  [Resource.Webhook]: {
    _resource: { i18nKey: "pbac_resource_webhook" },
    [CrudAction.Create]: {
  ...
  [Resource.Availability]: {
    _resource: { i18nKey: "pbac_resource_availability" },
    [CrudAction.Create]: {
  ...
  [Resource.OutOfOffice]: {
    _resource: { i18nKey: "pbac_resource_out_of_office" },
    [CrudAction.Create]: {
  ...
  [Resource.Watchlist]: {
    _resource: { i18nKey: "pbac_resource_blocklist" },
    [CrudAction.Create]: {
  ...
  [Resource.FeatureOptIn]: {
    _resource: { i18nKey: "pbac_resource_feature_opt_in" },
    [CrudAction.Read]: {
