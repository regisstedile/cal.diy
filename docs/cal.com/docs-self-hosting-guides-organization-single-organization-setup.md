...
*   [Installation](https://www.cal.diy/installation) - Learn how to install and set up Cal.diy
*   [Database Migrations](https://www.cal.diy/database-migrations) - Manage database schema changes
*   [Upgrading](https://www.cal.diy/upgrading) - Keep your instance up to date
*   [Docker](https://www.cal.diy/docker) - Deploy with Docker
*   [Apps](https://www.cal.diy/apps/google) - Set up third-party integrations

## Deployments

Deploy Cal.diy on your preferred platform:

*   [AWS](https://www.cal.diy/deployments/aws)
*   [Azure](https://www.cal.diy/deployments/azure)
*   [Elestio](https://www.cal.diy/deployments/elestio)
*   [GCP](https://www.cal.diy/deployments/gcp)
*   [Northflank](https://www.cal.diy/deployments/northflank)
*   [Railway](https://www.cal.diy/deployments/railway)
*   [Render](https://www.cal.diy/deployments/render)
*   [Vercel](https://www.cal.diy/deployments/vercel)
...
| Workspace Platform | ❌ | ✅ |
| Admin Panel | ❌ | ✅ |
|  | [Install](https://www.cal.diy/installation) | [[signup|Sign up]] |

Last updated on

April 26, 2026

[Installation](https://www.cal.diy/installation "Installation")
