---
title: "Get all out-of-office entries for the authenticated user"
...
```
curl --request GET \
  --url 'https://api.cal.com/v2/me/ooo?take=250' \
...
[[docs-api-reference-v2-slots-delete-a-reserved-slot|Delete a reserved slot]][[docs-api-reference-v2-out-of-office-create-an-out-of-office-entry-for-the-authenticated-user|Create an out-of-office entry for the authenticated user]]
