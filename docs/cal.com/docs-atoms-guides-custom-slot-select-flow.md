...
If you want to trigger a custom action immediately when a user selects a timeslot (before the booking form appears), you can use the `handleSlotReservation` prop. This prop allows you to intercept the slot selection event, enabling you to run custom logic—such as calling the reserve slot API.**Example usage:**
...
See the [[docs-api-reference-v2-slots-reserve-a-slot|Reserve a Slot API]] documentation for more details on reserving slots programmatically.

Was this page helpful?

Yes No

[[docs-atoms-guides-custom-booking-flow|Custom booking flow]][[docs-atoms-guides-replacing-toasts|Custom toasts]]
