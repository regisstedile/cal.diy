...
[[docs-api-reference-v2-teams-event-types-create-an-event-type|Create an event type]][[docs-api-reference-v2-teams-event-types-get-an-event-type|Get an event type]]
