...
Required membership role: `team admin`. PBAC permission: `eventType.create`. Learn more about API access control at [[docs-api-reference-v2-access-control|https://cal.com/docs/api-reference/v2/access-control]]. If accessed using an OAuth access token, the `TEAM_EVENT_TYPE_WRITE` scope is required.
...
[[docs-api-reference-v2-orgs-teams-conferencing-save-conferencing-app-oauth-credentials|Save conferencing app OAuth credentials]][[docs-api-reference-v2-orgs-teams-event-types-get-team-event-types|Get team event types]]
