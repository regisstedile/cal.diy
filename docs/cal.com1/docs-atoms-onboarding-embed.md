...
| `scope` | `string[]` | Yes | OAuth scopes to request. Must be a subset of scopes registered on the OAuth client. See the [[docs-api-reference-v2-oauth|OAuth scopes documentation]]. |
...
After the user grants access, you receive an authorization code that you exchange for access and refresh tokens using the [[docs-api-reference-v2-oauth|token endpoint]].
