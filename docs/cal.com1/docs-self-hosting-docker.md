...
2.   Open a browser to [http://localhost:3000](http://localhost:3000/), or your defined NEXT_PUBLIC_WEBAPP_URL. The first time you run Cal.diy, a setup wizard will initialize. Define your first user, and you’re ready to go!
