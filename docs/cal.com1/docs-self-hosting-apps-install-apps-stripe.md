...
2.   **Set up a Stripe webhook** - Open [Stripe Webhooks](https://dashboard.stripe.com/webhooks) and add:
...
[Sendgrid](https://www.cal.diy/apps/sendgrid "Sendgrid")[Twilio](https://www.cal.diy/apps/twilio "Twilio")
