...
1.   **Configure Allow List and Subdomain Check** - Add the redirect URL to the allow list and enable “Subdomain check”. Ensure it displays “saved” below the form.

2.   **Skip Basic Information and Add Scopes** - You don’t need to provide basic information about your app. Instead, go to “Scopes”, click ”+ Add Scopes”, then select the category “Meeting” on the left, and check the scope `meeting:write`.

3.   **Save the Scope** - Click “Done” to save the scope settings.

4.   **Complete Zoom Integration** - Your Zoom integration is now ready and can be easily added in the Cal.diy settings.

Last updated on

April 26, 2026

[Microsoft](https://www.cal.diy/apps/microsoft "Microsoft")[Daily](https://www.cal.diy/apps/daily "Daily")
