...
```
curl --request POST \
  --url https://api.cal.com/v2/teams/{teamId}/verified-resources/phones/verification-code/request \
...
[[docs-api-reference-v2-teams-verified-resources-request-email-verification-code|Request email verification code]][[docs-api-reference-v2-teams-verified-resources-verify-an-email-for-a-team|Verify an email for a team]]
